    ...
    <table class="table table-bordered align-middle">
        ...
        @foreach($fireExtinguishers as $fireExtinguisher)
            <tr style="background-color: rgb(253, 245, 246)">
                <td style="border-left: 10px solid red">{{ $fireExtinguisher->id }}</td>
                <td>
                ...
                <td>
                    ...
                    {{ $fireExtinguisher->fireExtinguisherType->fire_extinguisher_type }}
                </td>
                <td>{{ $fireExtinguisher->productionDate }}</td>
                <td>
